...
if __name__ == '__main__':
    ...
    eleven_starters_pool=["YIXIYIYI", "ZYXIYIZY", "YIZYXIZY", "ZZYXYYII", "XXIZIIXY", "YIZYZXYI", "XIYZYZYI", "XZIIYZII", "ZXXZZXYI","XXIIIIXY", "IYYZXIZY"]
    Resultat=[]
    ...
    vqe_methods_add_by_one.adapt_vqe(geometry,
                          ...
                          Pool            = eleven_starters_pool,
                          Resultat        = Resultat,
                          bond_legth      = dist
                          ) 
            
    with open('Bond_length_dependence.eleven_starters_{}'.format(dist) , 'wb') as handle:
